...
// expose this function to the rest of our app using module.exports
module.exports = function(passport) {
    ...
    // local-signup processes our signup form
    ...
    // Passport standardizes info that comes back in its profile object. 
          ...
          if (!req.user) {
            ...
            User.findOne({ 'google.id' : profile.id }, function(err, user) {
                ...
                if (user) {
                    ...
                    // Set all of the relevant information as described by the User model
